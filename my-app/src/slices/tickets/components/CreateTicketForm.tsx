...
const priorities = [
  { value: 'Low', label: 'Low', color: '#43A047', hours: 72 },
  { value: 'Medium', label: 'Medium', color: '#1976D2', hours: 48 },
  { value: 'High', label: 'High', color: '#FFA726', hours: 24 },
  { value: 'Critical', label: 'Critical', color: '#D32F2F', hours: 8 },
];
...
export const CreateTicketForm = ({ onSuccess, onCancel, currentUserDepartment = 'IT' }: CreateTicketFormProps) => {
